...
// PUBLIC FUNCTIONS
// ----------------
export let x86Hash32 = function (key, seed) {
    //
...
export let x86Hash128 = function (key, seed) {
    //
...
export let x64Hash64 = function (key, seed) {
    var result = x64Hash128(key, seed).slice(8);
    return result;
};

export let x64Hash128 = function (key, seed) {
    //
    // Given a string and an optional seed as an int, returns a 128 bit
